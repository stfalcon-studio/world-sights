 ...
 */
class Version20160516111725 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE sight_recommend (id INT AUTO_INCREMENT NOT NULL, sight_id INT NOT NULL, user_id INT NOT NULL, message LONGTEXT DEFAULT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, INDEX IDX_EBB221E5983D68AB (sight_id), INDEX IDX_EBB221E5A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
